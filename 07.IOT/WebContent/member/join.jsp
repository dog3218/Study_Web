   ...
   <table>
      ...
      <tr>
         ...
         <td><input type="text" name="id" class="chk"
            onkeypress="if(event.KeyCode ==13){id_check();}"> <a
            class="btn-fill" id="btn-id">아이디 중복 확인</a>
            <div class="valid">아이디를 입력하세요(영문소문자, 숫자만 가능)</div></td>
      </tr>
      <tr>
         <th>*비밀번호</th>
         <td><input type="password" name="pw" class="chk">
            <div class="valid">비밀번호를 입력하세요(영문대/소문자, 소문자,숫자를 모두 포함)</div></td>
      </tr>
      <tr>
         <th>*비밀번호 확인</th>
      ...
      <tr>
         <th>*성별</th>
         <td><lable> <input type="radio" name="gender" value="남"
               checked="checked">남</lable> <lable> <input type="radio"
               name="gender" value="여">여</lable></td>
      </tr>
      <tr>
         <th>*이메일</th>
         <td><input type="text" name="email" class="chk">
            <div class="valid">이메일을 다시 입력하세요(영문소문자, 숫자만 가능)</div></td>
      </tr>
   </table>
   </form>
   <div class="btn_set">
      <a class="btn-fill" onclick="go_join()">회원가입</a> <a class="btn-fill"
   ...
   <script type="text/javascript">
      ...
      var join = {
         ...
         pw : {
            ...
            invalid : {
               code : 'valid',
               desc : '비밀번호는 영문 대/소문자,숫자만 입력가능.'
            },
            lack : {
               code : 'invalid',
               desc : '비밀번호는 영문 대/소문자,숫자를 모두 포함 해야됩니다.'
            },
            equl : {
               code : 'valid',
               desc : '비밀번호가 일치 합니다'
         ...
         pw_chk_status : function(pw_chk) {
            if (pw_chk == '')
               return this.empty;
            else if (pw_chk == $('[name=pw]').val())
               return this.pw.equl;
            else
               return this.pw.notequl;
         },
